    ...
    <div className="card">
                ...
                <div className={styles.action}>
                    ...
                    <svg fill="none" viewBox="0 0 24 24" height={14} width={14} xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M12 19V4" />
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M7 15L11.2929 19.2929C11.6262 19.6262 11.7929 19.7929 12 19.7929C12.2071 19.7929 12.3738 19.6262 12.7071 19.2929L17 15" />
                    </svg>
                    </button>
                    <button type="button">
                    <svg fill="none" viewBox="0 0 24 24" height={14} width={14} xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M12 5L12 20" />
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M7 9L11.2929 4.70711C11.6262 4.37377 11.7929 4.20711 12 4.20711C12.2071 4.20711 12.3738 4.37377 12.7071 4.70711L17 9" />
                    </svg>
                    </button>
                    <p className={styles.label}>Navigate
                    </p></div>
                <div className={styles.action}>
                    <button type="button">
                    <svg fill="none" viewBox="0 0 24 24" height={14} width={14} xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M20 3V5.07692C20 7.07786 20 8.07833 19.8547 8.91545C19.0547 13.5235 15.0934 17.1376 10.0426 17.8674C9.12509 18 7.19318 18 5 18" />
                        <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="2.5" stroke="#5F6368" d="M7 21C6.39316 20.4102 4 18.8403 4 18C4 17.1597 6.39316 15.5898 7 15" />
                    </svg>
                    </button>
                    <p className={styles.label}>Select
                    </p>
                </div>
                <div className={styles.action}>
                    <button type="button">
                    ...
                    <p className={styles.label}>Quit
                    </p>
                </div>
                <p className={styles.labeledit}>Edit Actions
                </p>
            </div>
    </div>
