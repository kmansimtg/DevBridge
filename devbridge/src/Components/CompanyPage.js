                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          <div className={styles.hover_color_bubble} />
                          <div className={styles.so_top_icon}>
                            <svg xmlns="http://www.w3.org/2000/svg" width={40} viewBox="0 0 512 512" height={50} id="Layer_1">
                              <g>
                                <g>
                                  <g>
                                    <g>
                                      <path fill="#fae19e" d="m47.478 452.317 295.441 19.76c5.511.369 10.277-3.8 10.645-9.31l28.393-424.517c.369-5.511-3.8-10.276-9.31-10.645l-295.441-19.76c-5.511-.369-10.276 3.8-10.645 9.31l-28.394 424.517c-.368 5.511 3.8 10.277 9.311 10.645z" />
                                    </g>
                                    <g>
                                      <g>
                                        <g>
                                          <g>
                                            <g>
                                              <path fill="#fff9e9" d="m17.5 504.177h226.14l79.96-79.605v-355.86c0-5.523-4.477-10-10-10h-296.1c-5.523 0-10 4.477-10 10v425.466c0 5.522 4.477 9.999 10 9.999z" />
                                            </g>
                                            <path fill="#fff4d6" d="m313.601 58.712h-40c5.523 0 10 4.477 10 10v355.861l-.258 40.078 40.258-40.078v-355.861c0-5.523-4.477-10-10-10z" />
                                          </g>
                                        </g>
                                      </g>
                                      <path fill="#ffeec2" d="m243.64 504.177v-70.253c0-5.523 4.477-10 10-10h69.96z" />
                                    </g>
                                  </g>
                                  <g>
                                    <path fill="#fed23a" d="m468.636 248.58-33.372.165v-50.826c0-9.183 7.463-16.662 16.673-16.708h.007c9.217-.046 16.693 7.371 16.693 16.562v50.807z" />
                                    <path fill="#54b1ff" d="m451.96 504.177c-10.362-10.277-16.196-24.263-16.208-38.857l-.062-73.973c0-.644.524-1.169 1.171-1.173l30.038-.149c.647-.003 1.171.517 1.171 1.161l.062 74.079c.012 14.531-5.749 28.472-16.015 38.756z" />
                                    <path fill="#fdf385" d="m451.959 469.333h-.01c-14.434.072-26.14-11.542-26.14-25.935v-213.527c0-6.778 5.477-12.283 12.255-12.316l27.626-.137c6.826-.034 12.378 5.49 12.378 12.316v213.436c0 14.38-11.687 26.091-26.109 26.163z" />
                                    <path fill="#faee6e" d="m465.69 217.417-23.769.118c6.037.79 10.708 5.94 10.708 12.198v213.437c0 9.823-5.455 18.397-13.507 22.87 3.79 2.115 8.164 3.317 12.826 3.293h.01c14.422-.072 26.109-11.783 26.109-26.163v-213.436c.001-6.826-5.551-12.351-12.377-12.317z" />
                                    <path fill="#54b1ff" d="m491.274 247.925-71.615.355c-7.305.036-13.226 5.968-13.226 13.248 0 7.281 5.921 13.153 13.226 13.117l58.389-.29v77.489c0 7.281 5.921 13.153 13.226 13.117 7.305-.036 13.226-5.968 13.226-13.248v-90.672c0-7.28-5.922-13.152-13.226-13.116z" />
                                    <g>
                                      <path fill="#3da7ff" d="m491.274 247.925-38.441.188-.167 26.311 25.381-.067v77.489c0 7.281 5.921 13.153 13.226 13.117 7.305-.036 13.226-5.968 13.226-13.248v-90.672c.001-7.282-5.921-13.154-13.225-13.118z" />
                                    </g>
                                  </g>
                                </g>
                                <g fill="#060606">
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>ZEEKO LIVES LTD.</div>
                          </div>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>SHRIRAM PISTONS AND RINGS LIMITED</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>INFINITY SOLUTIONS</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                            They are a dynamic and innovative software development company that thrives on transforming visionary ideas into reality. Our talented team of tech enthusiasts, creative thinkers, and problem solvers are dedicated to delivering solutions that exceed client expectations.
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}> PETER ENGLAND </div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                              It is a long established organisation that works for in the field of men's fashion wear. They have been in the works since 1940 in India. Their products vary from Kurtas to Clean Office Shirts.
                            </p>
                            <p className={styles.hello3}>LOOKING FOR A BACKEND DEVELOPER</p>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>HELLO WORLD COMPANY 2.0</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                              They are a dynamic and innovative software development company that thrives on transforming visionary ideas into reality. Our talented team of tech enthusiasts, creative thinkers, and problem solvers are dedicated to delivering cutting-edge solutions that exceed client expectations.
                            </p>
                            <p className={styles.hello3}>LOOKING FOR SDE INTERN</p>
                            <button className={styles.read_more_btn} type="button">View Details</button>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}> HERA KOREA WORKS LTD</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                               It is a beauty luxury brand from Korea who endorses very popular celebrities like BLACKPINK Jennie and many more. They have been specilising in various products like their customised Jennie eye shadow pallette and foundations are avalible for almost 23 skin types.
                            </p>
                            <p className={styles.hello3}>LOOKING FOR A REACT DEVELOPER</p>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>WORLD OF WONDERS</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                    ...
                    <div className={styles.our_solution_category}>
                      <div className={styles.solution_cards_box}>
                        <div className={styles.solution_card}>
                          ...
                          <div className={styles.solu_title}>
                            <div className={styles.hello2}>SHAFT ZERO LTD</div>
                          </div>
                          <div className={styles.solu_description}>
                            <p>
                              It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                            </p>
                            <p className={styles.hello3}>LOOKING FOR A PYTHON DEVELOPER</p>
